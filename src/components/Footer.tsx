        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          <nav className="flex flex-wrap items-center justify-center sm:justify-start gap-x-5 gap-y-2" aria-label="Footer links">
            <a
              ...
              className="flex items-center gap-1.5 font-body text-body-sm text-ink-secondary dark:text-[#a1a1aa] hover:text-primary transition-colors duration-150"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-body text-body-sm text-ink-secondary dark:text-[#a1a1aa] hover:text-primary transition-colors duration-150"
            >
              CEITBA
            </a>
            <a
          ...
          <div className="flex items-center justify-center gap-2 font-body text-body-sm text-ink-secondary dark:text-[#a1a1aa]">
            <div className="relative">
              <button
                onMouseEnter={() => setShowCreators(true)}
                onMouseLeave={() => setShowCreators(false)}
                className="flex items-center gap-1.5 text-ink-secondary dark:text-[#a1a1aa] hover:text-primary transition-colors duration-150"
              >
