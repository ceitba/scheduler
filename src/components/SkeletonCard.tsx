export default function SkeletonCard() {
  return (
    <div
      className="rounded-card border border-border dark:border-[#3f3f46] bg-white dark:bg-[#27272a] overflow-hidden shadow-card animate-fade-in"
      aria-busy="true"
      aria-hidden="true"
    >
      ...
      <div className="p-5 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3 pt-2 border-t border-border dark:border-[#3f3f46] mt-2">
