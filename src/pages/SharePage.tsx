        ...
        <div className="container-content h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="min-h-[36px] px-2 font-mono text-label uppercase tracking-widest text-ink-secondary dark:text-[#a1a1aa] hover:text-primary"
            >
            ...
            <button
              ...
              className="min-h-[36px] w-9 flex items-center justify-center text-ink-secondary dark:text-[#a1a1aa] hover:text-primary"
            >
              {theme === 'dark' ? '☀' : '☾'}
            </button>
            <AuthMenu />
